...
class Page4State extends State<Page4> {
 ...
 Widget _zoomminusfunction() {
    ...
    return Align(
      ...
      child: IconButton(
            icon: Icon(Icons.search_off_rounded,color:Color(0xff6200ee)),
            onPressed: () {
              zoomVal--;
             _minus( zoomVal);
            }),
 ...
 Widget _zoomplusfunction() {
    ...
    return Align(
      ...
      child: IconButton(
            icon: Icon(Icons.search_rounded,color:Color(0xff6200ee)),
            onPressed: () {
              zoomVal++;
              _plus(zoomVal);
            }),
  ...
  Widget _buildGoogleMap(BuildContext context) {
    return Container(
      ...
      child: GoogleMap(
        ...
        initialCameraPosition:  CameraPosition(target: LatLng(36.7538, -74.005974), zoom: 12),
